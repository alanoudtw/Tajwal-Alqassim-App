...
public class AddActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnback3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),MainAdapterLayan3.class)); }
        });
        ...
        FirebaseDatabase.getInstance().getReference().child("Horse").push()
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(AddActivity3.this,"تم إضافة البيانات بنجاح",Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(Exception e) {
                        Toast.makeText(AddActivity3.this,"مشكلة أثناء الأضافة",Toast.LENGTH_SHORT).show();
                    }
                });
    }
